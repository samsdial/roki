...
if ( ! function_exists( 'understrap_woocommerce_wrapper_start' ) ) {
	...
	function understrap_woocommerce_wrapper_start() {
		...
		echo '<div class="pets pets-left--child pets-top">
		<div class="pets--child pets--child-top">
			<img src="https://ci.doki.com.co/wp-content/themes/dist-product/images/png/legs-left2.png" alt="" class="img-fluid">
		</div>
	</div>
	<div class="pets pets-right--child pets-bottom pets--child-bottom">
		<div class="pets--child">
			<img src="https://ci.doki.com.co/wp-content/themes/dist-product/images/png/legs-right.png" alt="" class="img-fluid">
		</div>
	</div>';
