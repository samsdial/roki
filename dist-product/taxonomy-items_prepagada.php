<?php
/**
 * The template Taxonomy items prepagada
 *
...
<div class="pets pets-left--child pets-top">
	...
	<div class="container" id="content" tabindex="-1">
		<div class="row">
			...
			<?php get_template_part( 'global-templates/left-sidebar-clear' ); ?>
			...
			<main class="site-main" id="main">
				...
				if ( have_posts() ) {
					...
					while ( have_posts() ) {
						 ...
						 */
						get_template_part( 'loop-templates/content-poliza', get_post_format() );
					}
				} else {
